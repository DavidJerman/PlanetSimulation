...
class Planet:
    ...
    def draw(self, win):
        ...
        if not self.sun:
            ...
            win.blit(distance_text, (x - distance_text.get_width() / 2, y - distance_text.get_height() / 2 + self.radius * 2))
...
def main():
    ...
    planet9 = Planet(3 * Planet.AU, 0, 12, BLUE, 6 * 10 ** 26)
    planet9.y_vel = -8 * 1000

    planets = [sun, earth, mars, mercury, venus, planet9]
